...
PROJECT_REPO := github.com/freshworks/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_VERSION := 1.97.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-spotinst
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-spotinst_v1.97.0_x5
