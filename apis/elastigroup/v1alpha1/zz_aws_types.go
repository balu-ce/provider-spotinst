...
type AwsParameters struct {
	...
	// +kubebuilder:validation:Optional
	ConsiderOdPricing *bool `json:"considerOdPricing,omitempty" tf:"consider_od_pricing,omitempty"`
	...
	// +kubebuilder:validation:Optional
	ImmediateOdRecoverThreshold *float64 `json:"immediateOdRecoverThreshold,omitempty" tf:"immediate_od_recover_threshold,omitempty"`
	...
	// +kubebuilder:validation:Optional
	MinimumInstanceLifetime *float64 `json:"minimumInstanceLifetime,omitempty" tf:"minimum_instance_lifetime,omitempty"`
	...
	// +kubebuilder:validation:Optional
	OndemandCount *float64 `json:"ondemandCount,omitempty" tf:"ondemand_count,omitempty"`
	...
	// +kubebuilder:validation:Optional
	WaitForCapacity *float64 `json:"waitForCapacity,omitempty" tf:"wait_for_capacity,omitempty"`

	// +kubebuilder:validation:Optional
	WaitForCapacityTimeout *float64 `json:"waitForCapacityTimeout,omitempty" tf:"wait_for_capacity_timeout,omitempty"`
}
...
type IntegrationDockerSwarmParameters struct {
	...
	// +kubebuilder:validation:Required
	MasterPort *float64 `json:"masterPort" tf:"master_port,omitempty"`
}
...
type ItfParameters struct {
	...
	// +kubebuilder:validation:Optional
	MigrationHealthinessThreshold *float64 `json:"migrationHealthinessThreshold,omitempty" tf:"migration_healthiness_threshold,omitempty"`
...
type OnFailureParameters struct {
	...
	// +kubebuilder:validation:Optional
	BatchNum *float64 `json:"batchNum,omitempty" tf:"batch_num,omitempty"`
...
type RollConfigParameters struct {
	...
	// +kubebuilder:validation:Optional
	WaitForRollTimeout *float64 `json:"waitForRollTimeout,omitempty" tf:"wait_for_roll_timeout,omitempty"`
}
